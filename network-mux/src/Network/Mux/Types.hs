...
-- The inner STM action provides the result of the miniprotocol, and an STM action that can be
-- used to restart the miniprotocol.
newtype MiniProtocolInitiatorControl m a = MiniProtocolInitiatorControl (STM m (STM m (a, MiniProtocolInitiatorControl m a)))
